...
Этот репозиторий — мое портфолио, в котором собраны решения практических задач из курса **"Симулятор для аналитиков" от Karpov.courses**. Все проекты основаны на данных гипотетического социального приложения, в котором пользователи могут просматривать ленту новостей и обмениваться сообщениями в мессенджере.
